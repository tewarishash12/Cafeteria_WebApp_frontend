...
function MenuCard({ item }) {
    ...
    return (
        <div className="bg-gray-900 rounded-lg shadow-md overflow-hidden hover:shadow-xl transition duration-300">
            ...
            />
            <div className="p-4">
                <h2 className="text-lg mb-2 text-teal-400 font-bold">{item.dish_name}</h2>
                <p className="text-gray-400 text-sm mb-2">{item.description}</p>
                <p className="text-yellow-400 font-semibold mb-2">Price: ₹{item.price}</p>
                <p
                ...
                <div className="flex flex-wrap gap-3 mt-4">
                    ...
                    <button
                        className="bg-red-400 hover:bg-red-500 text-gray-900 px-4 py-2 rounded-lg transition"
